...
Route::post('/store-polyline', [PolylinesController::class, 'store'])->name('polyline.store');

Route::resource('polylines', PolylinesController::class);

Route::post('/store-polygon', [PolygonsController::class, 'store'])->name('polygon.store');
